...
urlpatterns = patterns('',
    ...
    url(r'^community/student/$', views.StudentTipView.as_view(), name='student'),
    ...
    url(r'^board/notice/$', views.NoticeView.as_view(), name='notice_detail'),
    url(r'^board/program/$', views.ProgramView.as_view(), name='program_detail'),
    ...
    url(r'^sermons/(?P<pk>\d+)/$', views.SermonDetailView.as_view(), name='sermon_detail'),
